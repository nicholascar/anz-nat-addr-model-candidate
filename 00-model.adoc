...
| `role:` | `https://w3id.org/profile/anz-address/addressRoleTypes/` | Placeholder for the Address Roles Vocabulary
...
==== Example Data
Example Data used in this document, for instance in model element "Example" values, are https://www.w3.org/RDF/[RDF] data in the https://www.w3.org/TR/turtle/[Turtle] tyntax.
...
include::01-supporting-vocabularies.adoc[]

:sectnums!:

include::02-annex-a-validator.adoc[]
