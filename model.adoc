...
* machine-readable form: http://w3id.org/profile/anz-address/validator
...
| http://w3id.org/profile/anz-address/validator/sh-01[sh01] | Address Components' types must be indicated by an IRI (of a Concept from a vocabulary)
