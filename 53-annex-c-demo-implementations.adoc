...
|`a:GAQLD161268186` | `isov1:flatNumber` | "2"^^xsd:integer | "2"
|`a:GAQLD161268186` | `isov1:numberFirst` | "18"^^xsd:integer | "18"
|`a:GAQLD161268186` | `isov1:streetLocality` | `sl:QLD140492` | "Oxford Place"
|`a:GAQLD161268186` | `isov1:locality` | `l:loc38f189794e03` | "Shorncliffe"
|===
